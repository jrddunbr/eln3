...
open class SingleTechnical(uuid: String, block: ITechnicalBlock, state: BlockState, entity: ITechnicalEntity?, pos: BlockPos, level: Level): TechnicalBase(uuid, block, state, entity, pos, level), TagSerializable {
